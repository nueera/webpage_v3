...
import {
  ...
  CheckCircle2, Shield, Send, MapPin, AlertCircle, Loader2,
} from 'lucide-react';
        ...
        <div className="container-nueera">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              {submitted ? (
                <div className="p-8 rounded-2xl bg-green-500/10 border border-green-500/20 text-center animate-fade-in">
